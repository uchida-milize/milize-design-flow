...
const clientName = 'テストデバッグ株式会社2';
const basePath = '/test-debug-0916b';
...
export default function ResourcesPage() {
  ...
  useEffect(() => {
    Promise.all([
      fetch(`https://raw.githubusercontent.com/uchida-milize/milize-design-flow/main/src/app/test-debug-0916b/globals.css?t=${Date.now()}`).then(r => r.text()),
      fetch(`https://raw.githubusercontent.com/uchida-milize/milize-design-flow/main/src/app/test-debug-0916b/resources.json?t=${Date.now()}`).then(r => r.json()),
    ]).then(([css, json]) => {
  ...
  return (
    <div className="test-debug-0916b-portal">
