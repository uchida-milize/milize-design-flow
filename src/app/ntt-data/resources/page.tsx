...
const clientName = '株式会社NTTデータグループ';
const basePath = '/ntt-data';
...
export default function ResourcesPage() {
  ...
  useEffect(() => {
    Promise.all([
      fetch(`https://raw.githubusercontent.com/uchida-milize/milize-design-flow/main/src/app/ntt-data/globals.css?t=${Date.now()}`).then(r => r.text()),
      fetch(`https://raw.githubusercontent.com/uchida-milize/milize-design-flow/main/src/app/ntt-data/resources.json?t=${Date.now()}`).then(r => r.json()),
    ]).then(([css, json]) => {
