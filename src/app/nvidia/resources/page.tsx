...
const clientName = 'NVIDIA Corporation';
const basePath = '/nvidia';
...
export default function ResourcesPage() {
  ...
  useEffect(() => {
    Promise.all([
      fetch(`https://raw.githubusercontent.com/uchida-milize/milize-design-flow/main/src/app/nvidia/globals.css?t=${Date.now()}`).then(r => r.text()),
      fetch(`https://raw.githubusercontent.com/uchida-milize/milize-design-flow/main/src/app/nvidia/resources.json?t=${Date.now()}`).then(r => r.json()),
    ]).then(([css, json]) => {
