...
const colorRatio = [
  { hex: '#0084FF', name: 'プライマリカラー', percent: 29 },
  { hex: '#79BEFF', name: 'セカンダリカラー', percent: 26 },
  { hex: '#DDDDDD', name: 'アクセントカラー', percent: 24 },
  { hex: '#32373C', name: 'サポートカラー', percent: 9 },
  { hex: '#333333', name: 'サブカラー', percent: 12 },
];
