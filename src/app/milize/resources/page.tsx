...
export default function ResourcesPage() {
  ...
  useEffect(() => {
    Promise.all([
      fetch(`https://raw.githubusercontent.com/uchida-milize/milize-design-flow/main/src/app/milize/globals.css?t=${Date.now()}`).then(r => r.text()),
      fetch(`https://raw.githubusercontent.com/uchida-milize/milize-design-flow/main/src/app/milize/resources.json?t=${Date.now()}`).then(r => r.json()),
    ]).then(([css, json]) => {
