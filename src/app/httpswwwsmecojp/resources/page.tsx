...
const clientName = '株式会社ソニー・ミュージックエンタテインメント';
const basePath = '/httpswwwsmecojp';
...
export default function ResourcesPage() {
  ...
  useEffect(() => {
    Promise.all([
      fetch(`https://raw.githubusercontent.com/uchida-milize/milize-design-flow/main/src/app/httpswwwsmecojp/globals.css?t=${Date.now()}`).then(r => r.text()),
      fetch(`https://raw.githubusercontent.com/uchida-milize/milize-design-flow/main/src/app/httpswwwsmecojp/resources.json?t=${Date.now()}`).then(r => r.json()),
    ]).then(([css, json]) => {
  ...
  return (
    <div className="httpswwwsmecojp-portal">
