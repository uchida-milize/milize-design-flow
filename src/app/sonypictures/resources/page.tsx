...
const clientName = 'ソニー・ピクチャーズ エンタテインメント';
const basePath = '/sonypictures';
...
export default function ResourcesPage() {
  ...
  useEffect(() => {
    Promise.all([
      fetch(`https://raw.githubusercontent.com/uchida-milize/milize-design-flow/main/src/app/sonypictures/globals.css?t=${Date.now()}`).then(r => r.text()),
      fetch(`https://raw.githubusercontent.com/uchida-milize/milize-design-flow/main/src/app/sonypictures/resources.json?t=${Date.now()}`).then(r => r.json()),
    ]).then(([css, json]) => {
  ...
  return (
    <div className="sonypictures-portal">
